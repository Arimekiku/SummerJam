...
public abstract class EnemyRangeWeapon : EnemyWeapon
{
    ...
    {
        poolObject = new Pool<BotBullet>(ammoPrefab, ammoContainer);
        poolObject.CreatePool(5);
        
        foreach (BotBullet bullet in poolObject.Entities)
